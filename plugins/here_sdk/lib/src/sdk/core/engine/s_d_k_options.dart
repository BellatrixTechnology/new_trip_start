...
///         android:value="SOME_URL" />
/// <meta-data
///         android:name="com.here.sdk.authentication_baseurl"
///         android:value="SOME_URL" />
/// <meta-data
///         android:name="com.here.sdk.ds_proxy_url"
///         android:value="SOME_URL" />
/// ```
...
class SDKOptions {
  ...
  /// default path will be used and the default path is `<Application_Home>/Library/Caches` for iOS
  /// and `Context.getCacheDir().getPath()` for Android.
  ...
  /// to the desired location for which the application has read/write permissions.
  /// The path can be on internal or external storage. If it is not set, the
  /// default path will be used and the default path is `Application Library directory` for iOS
  /// and `Context.getFilesDir().getPath()` for Android.
  /// If path is relative then directory
