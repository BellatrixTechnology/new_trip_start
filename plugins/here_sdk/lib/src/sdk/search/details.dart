...
class Details {
  ...
  /// customers. The field is always null for everyone that is not part of the closed-alpha group.
  /// There could be a few bugs and unexpected behaviors.
  /// Related APIs may change for new releases without a deprecation process.
  /// This feature is only available in online search and only if it is explicitly enabled.
