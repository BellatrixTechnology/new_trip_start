...
/// marker. Cluster groupings are generated based on geographical distance between objects, not based
/// on screen space collision. Hence it is possible, that cluster markers can overlap. The markers
/// can be added to a cluster or to a scene, but not to both.
