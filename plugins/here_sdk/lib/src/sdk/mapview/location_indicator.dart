...
abstract class LocationIndicator implements MapViewLifecycleListener {
  ...
  /// Determines whether the horizontal accuracy passed to [LocationIndicator.updateLocationAndCamera] is visualized by
  /// scaling the accuracy indicator halo accordingly. By default, this flag is set to false. In
  /// this case the accuracy indicator has a fixed and zoom level independent size. When set to
  /// true the halo has a larger size when the horizontal accuracy of the location is larger. The
  /// radius of the indicator corresponds to the value of [Location.horizontalAccuracyInMeters]
  /// passed to [LocationIndicator.updateLocationAndCamera] and scales in world coordinates. For values smaller than 20
  /// meters the halo is hidden. The size of the indicator is limited to 500 meters and
  /// passing higher values or passing 'null' will keep the halo in that size.
  /// If the location indicator is set to inactive [LocationIndicator.isActive] then the accuracy indicator
  /// is always hidden while the value of this property remains unchanged.
