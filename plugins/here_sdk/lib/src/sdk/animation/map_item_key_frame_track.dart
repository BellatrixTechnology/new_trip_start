...
abstract class MapItemKeyFrameTrack {
  ...
  /// Creates a polyline progress keyframe track.
  ///
  /// It enables animations over the progress of a
  /// polyline.
  ///
  /// [keyframes] The list of keyframes that specify how the polyline progress is changed.
  ///
  /// [easingFunction] The easing function to apply during keyframe interpolation.
  ///
  /// [interpolationMode] The type of interpolation done between keyframe values.
...
final _polylineProgressReturnReleaseHandle = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Void Function(Pointer<Void>),
    void Function(Pointer<Void>)
...
final _polylineProgressReturnGetResult = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Pointer<Void> Function(Pointer<Void>),
    Pointer<Void> Function(Pointer<Void>)
...
final _polylineProgressReturnGetError = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Uint32 Function(Pointer<Void>),
    int Function(Pointer<Void>)
...
final _polylineProgressReturnHasError = __lib.catchArgumentError(() => __lib.nativeLibrary.lookupFunction<
    Uint8 Function(Pointer<Void>),
    int Function(Pointer<Void>)
...
class MapItemKeyFrameTrack$Impl extends __lib.NativeBase implements MapItemKeyFrameTrack {
  ...
  MapItemKeyFrameTrack polylineProgress(List<ScalarKeyframe> keyframes, EasingFunction easingFunction, KeyframeInterpolationMode interpolationMode) {
    ...
    sdkAnimationEasingfunctionReleaseFfiHandle(_easingFunctionHandle);
    sdkAnimationKeyframeinterpolationmodeReleaseFfiHandle(_interpolationModeHandle);
    if (_polylineProgressReturnHasError(__callResultHandle) != 0) {
        final __errorHandle = _polylineProgressReturnGetError(__callResultHandle);
        _polylineProgressReturnReleaseHandle(__callResultHandle);
        try {
          throw MapItemKeyFrameTrackInstantiationException(sdkAnimationMapitemkeyframetrackInstantiationerrorcodeFromFfi(__errorHandle));
        } finally {
          sdkAnimationMapitemkeyframetrackInstantiationerrorcodeReleaseFfiHandle(__errorHandle);
    ...
    final __resultHandle = _polylineProgressReturnGetResult(__callResultHandle);
    _polylineProgressReturnReleaseHandle(__callResultHandle);
    try {
      return sdkAnimationMapitemkeyframetrackFromFfi(__resultHandle);
    } finally {
