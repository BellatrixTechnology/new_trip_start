...
class RatingService {
  ...
  askForRating(BuildContext context) async {
    pref = await SharedPreferences.getInstance();
    // pref.clear();

    if (await inAppReview.isAvailable()) {
      count = pref.getInt(key);
      print("count -> $count");
    ...
    // print("rateMyApp ${rateMyApp.conditions.map((e) => print(e))}");
    // // print("rateMyApp ${rateMyApp.}");
