...
class RoutingService {
  ...
  MapImage mapImage = MapImage.withFilePathAndWidthAndHeight(
      'assets/images/my-marker.png', 50, 50);
  MapImage otherImage = MapImage.withFilePathAndWidthAndHeight(
      'assets/images/dest-icon.png', 50, 50);
  ...
  _showRouteOnMap(here.Route route) {
    ...
    MapMarker myMarker = MapMarker(route.boundingBox.northEastCorner, mapImage);
    MapMarker destMarker =
        MapMarker(route.boundingBox.southWestCorner, mapImage);
    ...
    MapPolyline routeMapPolyline =
        MapPolyline(routeGeoPolyline, widthInPixels, kPrimaryColor);
