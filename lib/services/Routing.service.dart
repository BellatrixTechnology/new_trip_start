...
class RoutingService {
  ...
  routeDetailPath(HereMapController hereMapController, int index) {
    ...
    // var geoBox = GeoBox(GeoCoordinates(start['lat'], start['lng']),
    //     GeoCoordinates(end['lat'], end['lng']));
    // var bearing; //= 45.0; // Set null, to keep bearing unchanged.
    // var tilt = 0.0;
    // var orientation = GeoOrientationUpdate(bearing, tilt);
    // hereMapController.camera.lookAtAreaWithGeoOrientation(geoBox, orientation);
