...
class EnvConfig {
  ...
  static String get hereAccessKeySecret => dotenv.env['HERE_ACCESS_KEY_SECRET'] ?? '';
  static String get hereTokenEndpointUrl => dotenv.env['HERE_TOKEN_ENDPOINT_URL'] ?? '';
  
  // Android Signing (for build scripts)
  static String get androidStorePassword => dotenv.env['ANDROID_STORE_PASSWORD'] ?? '';
  static String get androidKeyPassword => dotenv.env['ANDROID_KEY_PASSWORD'] ?? '';
